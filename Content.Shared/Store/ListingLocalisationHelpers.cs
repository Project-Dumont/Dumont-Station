...
{
    private static readonly ProtoId<DatasetPrototype> UplinkDiscountFluffDataset = "UplinkDiscountFluff";
    ...
    public static string GetLocalisedDescriptionOrEntityDescription(ListingData listingData, IPrototypeManager prototypeManager)
    {
        ...
        var discountFluff = _rand.Pick(_protoMan.Index(UplinkDiscountFluffDataset).Values);
