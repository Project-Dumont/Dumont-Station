...
advanced-anomaly-generator-ui-title = Advanced Anomaly Generator
advanced-anomaly-generator-ui-anomaly = Anomaly
advanced-anomaly-generator-ui-resources = Resources
advanced-anomaly-generator-ui-map = Station tile selector
advanced-anomaly-generator-ui-use-machine-tile = Use machine tile
advanced-anomaly-generator-ui-selected-tile = Selected station tile: [color=cyan]{ $x }, { $y }[/color]
advanced-anomaly-generator-ui-generate = Generate anomaly
advanced-anomaly-generator-ui-anomaly-entry = { $name } ({ $cost } research)
advanced-anomaly-generator-ui-log = Activity Log
advanced-anomaly-generator-ui-card-research = [color=cyan]{ $cost }[/color] [color=#aaaaaa]research[/color]
advanced-anomaly-generator-ui-card-plasma = [color=#4fc3f7]{ $cost }[/color] [color=#aaaaaa]solid plasma[/color]
advanced-anomaly-generator-ui-resource-status = Plasma: [color=cyan]{ $plasma }[/color] / [color=cyan]{ $plasmaCost }[/color]
    Research points: [color=cyan]{ $points }[/color]
advanced-anomaly-generator-ui-cost = Prototype: [color=gray]{ $prototype }[/color]
    Research cost: [color=cyan]{ $cost }[/color]
    Plasma cost: [color=cyan]{ $plasma }[/color]
advanced-anomaly-generator-ui-no-message = Awaiting a generation request.
advanced-anomaly-generator-ui-no-anomaly = No anomaly selected.
advanced-anomaly-generator-entry-pyroclastic = Pyroclastic anomaly
advanced-anomaly-generator-entry-gravity = Gravity anomaly
advanced-anomaly-generator-entry-electricity = Electricity anomaly
advanced-anomaly-generator-entry-ice = Ice anomaly
advanced-anomaly-generator-entry-flora = Flora anomaly
advanced-anomaly-generator-entry-bluespace = Bluespace anomaly
advanced-anomaly-generator-entry-tech = Tech anomaly
advanced-anomaly-generator-entry-rock = Rock anomaly
advanced-anomaly-generator-entry-santa = Santa anomaly
advanced-anomaly-generator-entry-shadow = Shadow anomaly
advanced-anomaly-generator-error-unpowered = The advanced anomaly generator is not powered.
advanced-anomaly-generator-error-invalid-anomaly = The selected anomaly is not configured or no longer exists.
advanced-anomaly-generator-error-plasma = Not enough solid plasma: { $available } / { $needed }.
advanced-anomaly-generator-error-no-server = The generator is not linked to a research server.
advanced-anomaly-generator-error-research = Not enough research points: { $available } / { $needed }.
advanced-anomaly-generator-error-no-station = No station grid was found for this map.
advanced-anomaly-generator-error-wrong-grid = The generator must be on the station's primary grid.
advanced-anomaly-generator-error-invalid-location = The chosen tile is not a valid station interior tile.
advanced-anomaly-generator-error-blocked-location = The chosen tile is blocked by an impassable anchored object.
advanced-anomaly-generator-success = Generated { $anomaly } at station tile { $x }, { $y }.
advanced-anomaly-generator-announce = { $anomaly } generated by { $user } near { $location }.
advanced-anomaly-generator-announce-unknown-user = an unknown operator
advanced-anomaly-generator-error-cooldown = The generator is recharging. Time remaining: { $time }.