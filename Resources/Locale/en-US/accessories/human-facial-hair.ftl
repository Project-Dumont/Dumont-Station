...
marking-HumanFacialHairLumberjack = Beard (Lumberjack)
marking-HumanFacialHairLumberjackALT = Beard (Lumberjack ALT)
marking-HumanFacialHairProspectors = Beard (Prospector)
marking-HumanFacialHairBiggerbeard = Beard (Bigger)
marking-HumanFacialHairGoatman = Beard (Goat Man)
marking-HumanFacialHairBigStache = Mustache (Big Stache)
marking-HumanFacialHairBigStacheBeard = Beard (Big Stache)
marking-HumanFacialHairClocker = Beard (Clocker)
marking-HumanFacialHairClockerAlt = Beard (Clocker ALT)
