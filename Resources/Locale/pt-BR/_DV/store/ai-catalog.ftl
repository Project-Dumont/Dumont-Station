ai-rgb-lighting-name = Iluminação RGB
ai-rgb-lighting-desc = Ajusta o controle de cor de uma luz para adicionar ou remover um efeito RGB

ai-light-synthesizer-name = Sintetizador de Luz
ai-light-synthesizer-desc = Envia nanites para sintetizar uma lâmpada de reposição em um suporte de lâmpada
