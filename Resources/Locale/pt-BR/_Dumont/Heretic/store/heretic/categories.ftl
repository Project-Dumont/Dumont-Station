...
store-heretic-path-lock = Caminho da Fechadura
...
store-heretic-path-special = Conhecimentos especiais
store-heretic-path-side-t1 = Conhecimentos laterais T1
store-heretic-path-side-t2 = Conhecimentos laterais T2
store-heretic-path-side-t3 = Conhecimentos laterais T3
