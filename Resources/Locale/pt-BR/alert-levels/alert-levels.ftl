...
alert-level-doomsday-announcement = A-A Atenção! Atenção!!! O protocolo DOOMSDAY foi confirmado como estável estável estááável. Todos os silícios devem ser considerados ativamente benéficos e devem permanecer operacionais. Todos os tripulantes devem proteger e manter ativa a Inteligência Artificial da estação para garantir a conclusão do protocolo DOOmMSDAY, o sistema sistema-sistema de preservação da vida orgânica da estação.
