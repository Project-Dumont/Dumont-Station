paint-success = {CAPITALIZE(ARTIGO-O($target))} {$target} foi {MAKEGENDER("coberto", $target)} de tinta!
paint-failure = Não dá pra cobrir {ARTIGO-O($target)} {$target} de tinta!
paint-failure-painted = {CAPITALIZE(ARTIGO-O($target))} {$target} já está {MAKEGENDER("coberto", $target)} de tinta!
