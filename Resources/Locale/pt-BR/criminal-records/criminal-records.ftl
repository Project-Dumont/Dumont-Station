...
criminal-records-console-suspected = O {$officer} qualificou {$name} ({$job}) como suspeito em decorrência de: {$reason}
...
criminal-records-console-perma = {$name} ({$job}) foi sentenciado a perma por {$officer}.
