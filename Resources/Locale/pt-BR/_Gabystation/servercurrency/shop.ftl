...
gs-balanceui-shop-token-antag-remark = Comprou um antag token de "{$token}" - Transforme-se enquanto vivo na rodada.

gs-balanceui-shop-token-ghost-role-buy = Token fantasma de {$token}
