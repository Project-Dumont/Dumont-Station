...
public abstract partial class SharedContinuousBeamSystem : EntitySystem
{
    ...
    public bool ResolveBeamEndpointData(EntityUid uid,
        ...
        HereticComplexJointVisualsComponent joint)
    {
    ...
    public void StopFiring(EntityUid uid, ContinuousBeamGunComponent gun, HereticComplexJointVisualsComponent? joint)
    {
    ...
    public (Box2Rotated boxRot, Angle angle, float distToEndpoint, Vector2 Dir, Vector2 offset, Vector2 pos, Vector2
        endpointPos)?
        CalculateBeamDamageData(Entity<ContinuousBeamGunComponent, HereticComplexJointVisualsComponent> ent)
    {
