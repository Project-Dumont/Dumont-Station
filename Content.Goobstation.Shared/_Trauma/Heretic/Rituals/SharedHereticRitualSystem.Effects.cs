...
public abstract partial class SharedHereticRitualSystem
{
    ...
    private void OnSacrifice(Entity<MindContainerComponent> ent, ref HereticRitualEffectEvent<SacrificeEffect> args)
    {
        ...
        if (HasComp<HereticBodyComponent>(ent) && ent.Comp.LastMindStored is { } oldMind && oldMind != mind &&
        ...
        // Dumont start
        EntityManager.System<Content.Shared.Body.Systems.SharedBodySystem>().GibBody(ent);
