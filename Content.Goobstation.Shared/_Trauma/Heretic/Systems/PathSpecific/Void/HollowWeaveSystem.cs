...
public sealed partial class HollowWeaveSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<StatusEffectContainerComponent, AmmoShotUserEvent>((uid, comp, args) => _status.RelayEvent((uid, comp), args));
        SubscribeLocalEvent<StatusEffectContainerComponent, ThrowEvent>((uid, comp, args) => _status.RelayEvent((uid, comp), args));
