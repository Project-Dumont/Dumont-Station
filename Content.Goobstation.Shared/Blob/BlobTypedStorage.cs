...
{
    [DataField] public override FixedPoint2 Core { get; set; } = default!;
    [DataField] public override FixedPoint2 Invalid { get; set; } = default!;
    [DataField] public override FixedPoint2 Resource { get; set; } = default!;
    [DataField] public override FixedPoint2 Factory { get; set; } = default!;
    [DataField] public override FixedPoint2 Node { get; set; } = default!;
    [DataField] public override FixedPoint2 Reflective { get; set; } = default!;
    [DataField] public override FixedPoint2 Strong { get; set; } = default!;
    [DataField] public override FixedPoint2 Normal { get; set; } = default!;
}

[DataDefinition]
public sealed partial class BlobTileProto : BlobTypedStorage<EntProtoId<BlobTileComponent>>
{
    [DataField] public override EntProtoId<BlobTileComponent> Core { get; set; } = default!;
    [DataField] public override EntProtoId<BlobTileComponent> Invalid { get; set; } = default!;
    [DataField] public override EntProtoId<BlobTileComponent> Resource { get; set; } = default!;
    [DataField] public override EntProtoId<BlobTileComponent> Factory { get; set; } = default!;
    [DataField] public override EntProtoId<BlobTileComponent> Node { get; set; } = default!;
    [DataField] public override EntProtoId<BlobTileComponent> Reflective { get; set; } = default!;
    [DataField] public override EntProtoId<BlobTileComponent> Strong { get; set; } = default!;
    [DataField] public override EntProtoId<BlobTileComponent> Normal { get; set; } = default!;
}
