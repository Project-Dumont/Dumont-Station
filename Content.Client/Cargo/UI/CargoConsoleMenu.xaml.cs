...
namespace Content.Client.Cargo.UI
{
    ...
    public sealed partial class CargoConsoleMenu : FancyWindow
    {
        ...
        public void PopulateProducts()
        {
            ...
            var search = TextHelpers.RemoveAccents(SearchBar.Text.Trim().ToLowerInvariant());
            foreach (var prototype in products)
            {
                var name = TextHelpers.RemoveAccents(prototype.Name.ToLowerInvariant());
                var description = TextHelpers.RemoveAccents(prototype.Description.ToLowerInvariant());
