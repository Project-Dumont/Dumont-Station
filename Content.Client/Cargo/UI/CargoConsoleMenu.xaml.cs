...
namespace Content.Client.Cargo.UI
{
    ...
    public sealed partial class CargoConsoleMenu : FancyWindow
    {
        ...
        public void PopulateProducts()
        {
            ...
            var search = TextHelpers.RemoveAccents(SearchBar.Text.Trim().ToLowerInvariant()); // Gabystation
            foreach (var prototype in products)
            {
                var name = TextHelpers.RemoveAccents(prototype.Name.ToLowerInvariant()); // Gabystation
                var description = TextHelpers.RemoveAccents(prototype.Description.ToLowerInvariant()); // Gabystation
                ...
                if (search.Length == 0 && _category == null ||
                    ...
                    search.Length != 0 && description.Contains(search) ||
