...
public sealed partial class GunSystem : SharedGunSystem
{
    ...
    private void RenderDisplacementImpact(EntityCoordinates coords, Angle angle, EntityUid target)
    {
        ...
        _displacement.TryAddDisplacement(_displacementEffect.Displacement, (Entity<SpriteComponent>) EntityManager.GetEntity(ent), 0, "unshaded", out _, GetNetEntity(ent));
    }
