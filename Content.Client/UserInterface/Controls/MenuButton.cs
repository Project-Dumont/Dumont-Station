...
public sealed class MenuButton : ContainerButton
{
    ...
    public const string StyleClassDumontTopButton = "topButtonLabel";
    ...
    // Dumont Station
    private static readonly Color ColorDumontNormal = Color.FromHex("#527A25");
    private static readonly Color ColorDumontHovered = Color.FromHex("#527A25");
    ...
    // Dumont Station
    private Color NormalColorDumont => HasStyleClass(StyleClassDumontTopButton) ? ColorDumontNormal : NormalColorDumont;
    private Color HoveredColorDumont => HasStyleClass(StyleClassDumontTopButton) ? ColorDumontHovered : ColorHovered;
