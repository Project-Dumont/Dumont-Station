...
public sealed partial class HereticAbilitySystem
{
    ...
    private void OnCleave(EventHereticCleave args)
    {
        ...
        foreach (var (target, _) in GetNearbyPeople(args.Performer, args.Range, null, coords))
        {
            ...
            if (damageable != null)
                _lifesteal.LifeSteal(args.Performer, dmg.GetTotal(), damageable);
        ...
        foreach (var (_, _, woundable) in _body.GetBodyChildrenWithComponent<WoundableComponent>(args.Performer))
        {
