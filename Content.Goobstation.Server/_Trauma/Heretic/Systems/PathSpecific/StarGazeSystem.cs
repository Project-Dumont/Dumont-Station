...
public sealed partial class StarGazeSystem : EntitySystem
{
    ...
    {
        Entity<StarGazeComponent, ContinuousBeamGunComponent, HereticComplexJointVisualsComponent> combined = (ent, ent,
            args.Ent, args.Ent);
    ...
    private bool UpdateBeamState(Entity<StarGazeComponent, ContinuousBeamGunComponent, HereticComplexJointVisualsComponent> ent)
    {
    ...
    private void PullVictims(Entity<StarGazeComponent, ContinuousBeamGunComponent, HereticComplexJointVisualsComponent> ent)
    {
