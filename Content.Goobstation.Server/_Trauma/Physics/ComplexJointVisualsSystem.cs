...
public sealed partial class ComplexJointVisualsSystem : SharedComplexJointVisualsSystem
{
    ...
    public override void Update(float frameTime)
    {
        ...
        var query = EntityQueryEnumerator<HereticComplexJointVisualsComponent>();
    ...
    public List<RayCastResults>? BeamCollision(EntityUid origin, EntityUid target, HereticComplexJointVisualsData data, bool raiseEvents = true)
    {
