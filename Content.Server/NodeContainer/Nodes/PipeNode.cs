...
namespace Content.Server.NodeContainer.Nodes
{
    ...
    public partial class PipeNode : Node, IGasMixtureHolder, IRotatableNode
    {
            ...
            IEntityManager entMan)
        {
            ...
            var pos = mapSystem.CoordinatesToTile(gridUid, grid, xform.Coordinates);
            ...
            for (var i = 0; i < PipeDirectionHelpers.PipeDirections; i++)
            {
                ...
                foreach (var pipe in LinkableNodesInDirection(pos, pipeDir, gridUid, grid, nodeQuery, mapSystem))
                {
                    yield return pipe;
                }
            }
        ...
        {
            foreach (var pipe in PipesInDirection(pos, pipeDir, gridUid, grid, nodeQuery, mapSystem))
            {
