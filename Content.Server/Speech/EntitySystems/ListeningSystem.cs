...
{
    [Dependency] private readonly ChatSystem _chat = default!; // Gaby Station -> Language
    ...
    {
        PingListeners(ev.Source, ev.Message, ev.IsWhisper); // Gaby Station -> Language
    }

    public void PingListeners(
        EntityUid source,
        string message,
        bool isWhisper // Gaby Station -> Language
        )
    {
