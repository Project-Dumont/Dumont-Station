...
using UniversalLanguageSpeakerComponent = Content.Shared._Gabystation.Language.Components.UniversalLanguageSpeakerComponent;
using Content.Shared._Gabystation.Language.Components;
using Content.Server._Gabystation.Language.Events;
